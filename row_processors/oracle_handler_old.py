...
def process_oracle_row(index, pam_row, safe_user_list) -> tuple[list[list], list[list]]:
    ...
    # Domain ve OS
    domain = "nonDomain"     # İstersen OS envanter ile zenginleştirilebilir
    os_name = "oracle"       # Oracle yakalanmışsa OS'yi oracle olarak set ediyoruz (ignore etmeyiz)
    application = ""         # Şimdilik boş, gerekirse kural eklenir
    ...
    # prepare_workbook headers ile birebir uyumlu sıra:
