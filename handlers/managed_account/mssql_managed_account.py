...
from api.managed_account import (
    ...
    create_mssql_managed_account_api_call # MSSQL için de aynı API kullanılacak
)

def create_mssql_managed_account(row: dict, cache: UniversalCache) -> None:
    try:
        ...
        create_mssql_managed_account_api_call(managed_system_id, payload)
